...
import { WHATSAPP_URL, YOUTUBE_URL, EMAIL } from '@/lib/constants';
                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.brand}>
                        ...
                        <div className={styles.social}>
                            ...
                            <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="YouTube">
